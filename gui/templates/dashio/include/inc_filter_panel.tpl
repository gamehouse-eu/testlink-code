...
{if $control->display_settings}
  <div id="settings_panel" style="overflow: visible; margin-bottom: 5px; margin-left: 1px;">
    <div class="x-panel-header x-unselectable" style="overflow: visible;">
      {$labels.caption_nav_settings}
    </div>

    <div id="settings" class="x-panel-body" style="padding-top: 10px; padding-bottom: 0px; padding-left: 10px; overflow: visible;">
...
{if $control->display_filters}
  ...
  <div id="filter_panel" style="overflow: visible; margin-bottom: 5px; margin-left: 1px;">
    <div class="x-panel-header x-unselectable">
      {$labels.caption_nav_filters}
    </div>

  <div id="filters" class="x-panel-body" style="padding-top: 10px; padding-bottom: 10px; padding-left: 10px; overflow: visible;">
